export const ProgramSection = () => {
  const features = [
    ...
    "Implantação de 5 Agentes IPCs personalizados + 2 Agentes Autônomos", 
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="bg-vanguardia-light/5 flex items-center border border-gray-700 rounded-xl p-8 hover:border-vanguardia-green/50 transition-all duration-300 animate-slide-in"
